...
namespace overdose {
	...
	protected:
		...
		bool m_jumping = true, m_falling = true, m_gravityReset = false;
	...
	public:
		...
		void resetGravity() { m_gravityReset = true; }
		bool getGravityState() { return m_gravityReset; }
		void gravityFalse(){ m_gravityReset = false; }
